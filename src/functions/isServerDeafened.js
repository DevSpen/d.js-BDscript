module.exports = {
    ...
    description: "Returns whether or not a user is server-deafened.",
    returns: "?boolean",
    brackets: true,
    optional: true,
    fields: [{
    ...
    execute: async d => {
        if (!d.value.inside) {
            return d.deflate(d.message?.member?.voice.serverDeaf ?? "")
        }
        ...
        return d.deflate(member.voice.serverDeaf)
    }
}
